...
final class LocalizationExceptionTest extends AbstractExceptionTest
{
    public function testMissingTranslation(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'MISSING_TRANSLATION', "Missing translation for key '{$key}' in locale '{$locale}'");
    }
    ...
    public function testInvalidLocale(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'INVALID_LOCALE', "Invalid locale: {$locale}");
    }
}
