...
final class EventExceptionTest extends AbstractExceptionTest
{
    public function testListenerNotCallable(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'LISTENER_NOT_CALLABLE', "Event listener is not callable for event: {$eventName}", 1601);
    }
    ...
    public function testEventDispatchFailed(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'EVENT_DISPATCH_FAILED', "Failed to dispatch event: {$eventName}", 1602);
    }
}
