...
final class ContainerExceptionTest extends AbstractExceptionTest
{
    public function testServiceNotFound(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'SERVICE_NOT_FOUND', "Service not found in container: {$serviceId}");
    }
    ...
    public function testCircularDependency(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'CIRCULAR_DEPENDENCY', "Circular dependency detected for service: {$serviceId}");
    }
}
