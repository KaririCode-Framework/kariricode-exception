...
final class CacheExceptionTest extends AbstractExceptionTest
{
    public function testItemNotFound(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'CACHE_ITEM_NOT_FOUND', "Cache item not found: {$key}", 1201);
    }
    ...
    public function testStorageError(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'CACHE_STORAGE_ERROR', "Cache storage error: {$details}", 1202);
    }
    ...
    public function testInvalidTtl(): void
    {
        ...
        $this->assertExceptionStructure($exception, 'INVALID_TTL', "Invalid TTL value: {$ttl}", 1203);
    }
}
